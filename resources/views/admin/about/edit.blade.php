...
@section('title', 'Editar Quiénes Somos | SDAANIM')
@section('content')
<div style="max-width: 900px; margin: 40px auto; padding: 20px;">
    <div class="premium-card" style="padding: 40px;">
        <h2 style="color: #2c3e50; margin-bottom: 30px; border-bottom: 2px solid #f1f5f9; padding-bottom: 15px;">🏢 Editar Quiénes Somos (Historia)</h2>
        ...
        <form action="{{ route('admin.about.update') }}" method="POST">
            ...
            <div style="margin-top: 40px; display: flex; gap: 15px; border-top: 1px solid #f1f5f9; padding-top: 25px;">
                ...
                <a href="{{ route('admin.dashboard') }}" class="premium-btn" style="background: #f1f5f9; color: #475569; border: 1px solid #cbd5e1; padding: 14px 40px; font-size: 1.1em; border-radius: 12px; display: flex; align-items: center; justify-content: center;">Cancelar</a>
            </div>
        </form>
    </div>
</div>
